...
class IntegrationSubscriptionsApi(object):
    ...
    def delete_integration_subscription(self, subscription_id, **kwargs):  # noqa: E501
        """Delete an integration data subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_integration_subscription(subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_integration_subscription_with_http_info(subscription_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_integration_subscription_with_http_info(subscription_id, **kwargs)  # noqa: E501
            return data

    def delete_integration_subscription_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        """Delete an integration data subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_integration_subscription_with_http_info(subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('subscription_id' not in params or
            ...
            raise ValueError("Missing the required parameter `subscription_id` when calling `delete_integration_subscription`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/sounder/data-output/integration-subscriptions/{subscriptionId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_integration_subscription(self, subscription_id, **kwargs):  # noqa: E501
        """Get a particular integration data subscription specification  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_integration_subscription(subscription_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int subscription_id: The unique id of the subscription (required)
        :return: IntegrationSubscriptionSpecification
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_integration_subscription_with_http_info(subscription_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_integration_subscription_with_http_info(subscription_id, **kwargs)  # noqa: E501
            return data

    def get_integration_subscription_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        """Get a particular integration data subscription specification  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_integration_subscription_with_http_info(subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('subscription_id' not in params or
                params['subscription_id'] is None):
            raise ValueError("Missing the required parameter `subscription_id` when calling `get_integration_subscription`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/sounder/data-output/integration-subscriptions/{subscriptionId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IntegrationSubscriptionSpecification',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_integration_subscriptions(self, **kwargs):  # noqa: E501
        """Get all integration data subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_integration_subscriptions(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[IntegrationSubscriptionInfo]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_integration_subscriptions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_integration_subscriptions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_integration_subscriptions_with_http_info(self, **kwargs):  # noqa: E501
        """Get all integration data subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_integration_subscriptions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/sounder/data-output/integration-subscriptions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[IntegrationSubscriptionInfo]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_integration_state_with_http_info(self, subscription_id, state, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/sounder/data-output/integration-subscriptions/{subscriptionId}/integration-state', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_integration_subscription(self, subscription_id, settings, **kwargs):  # noqa: E501
        """Update an integration data subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_integration_subscription(subscription_id, settings, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int subscription_id: Id of the subscription (required)
        :param IntegrationSettings settings: New subscription settings (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_integration_subscription_with_http_info(subscription_id, settings, **kwargs)  # noqa: E501
        else:
            (data) = self.update_integration_subscription_with_http_info(subscription_id, settings, **kwargs)  # noqa: E501
            return data

    def update_integration_subscription_with_http_info(self, subscription_id, settings, **kwargs):  # noqa: E501
        """Update an integration data subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_integration_subscription_with_http_info(subscription_id, settings, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_integration_subscription" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'subscription_id' is set
        if ('subscription_id' not in params or
                params['subscription_id'] is None):
            raise ValueError("Missing the required parameter `subscription_id` when calling `update_integration_subscription`")  # noqa: E501
        # verify the required parameter 'settings' is set
        if ('settings' not in params or
                params['settings'] is None):
            raise ValueError("Missing the required parameter `settings` when calling `update_integration_subscription`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/sounder/data-output/integration-subscriptions/{subscriptionId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
